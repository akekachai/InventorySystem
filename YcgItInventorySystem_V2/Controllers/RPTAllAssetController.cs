...
{
    public class RPTAllAssetController : Controller
    {
        public YCGInventoryContext _YCGInventoryContext;
        private readonly IWebHostEnvironment _webHostEnviroment;

        public RPTAllAssetController(YCGInventoryContext ycginventoryContext, IWebHostEnvironment webHostEnvironment)
        {
        ...
        public IActionResult printreport(string printtype)
        {
            ...
            else
            {
                ...
                return File(result.MainStream, "application/msexcel", "RptInvAllAsset.xls");
            }
        }
